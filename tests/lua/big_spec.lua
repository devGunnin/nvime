...
describe('big change intake', function()
  ...
  it("threads the big_build lane's model dial into big.build", function()
    local _, path = sandbox()
    local models = require('nvime.models')
    open_on(path)
    local live = big.state()
...
describe('big change session states', function()
  ...
  it("threads the big_build lane's model dial into big.capture too, since it shares the build lane", function()
    local _, path = sandbox()
    local models = require('nvime.models')
    open_on(path)
    local live = big.state()
